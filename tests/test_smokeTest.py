...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("Duck123")
  ...
  def test_homePage2(self):
    ...
    self.vars["http://localhost:5500/teton/1.6/join.html"] = self.driver.execute_script("return window.location.href")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Isaias")
    self.driver.find_element(By.NAME, "lname").send_keys("Zuñiga")
